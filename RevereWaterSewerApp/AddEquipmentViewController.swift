//  AddEquipment.swift of the application, allows for numerous subclasses within that panel for the items
// Will test to see if items of QR code scanner will reappear within this
//  Created by Ahmed Ibreljic  on 08/03/20.
